...
| UI5 | Micro-motion: breathing scale 1.000 to 1.012 with a 4 s ease-in-out period while present; one settle of 6 px over 400 ms on arrival; blink omitted, crop misaligned by ~38 px; every loop stops when absent, hidden, or reduced-motion. | test/micro-motion.test.js | held |
