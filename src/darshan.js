...
// upper bounds over every style's walk-in (1583 to 3000 ms across the six sheet sets
// in assets/anim/manifest.js) and farewell (up to 3833 ms), rounded up to leave room
// for sheet decoding; test/sprite-player.test.js holds every style under them. The
// renderer fades the halo and caption over the selected style's own segment length;
// the CSS slide uses these values as its fallback.
const ARRIVAL_MS = 3_200;
